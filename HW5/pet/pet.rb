...
def change_life_states(user_login)
  if is_user_superadmin?(user_login)
    puts "Set new health level, from 1 to 10: "
    @health = gets.strip.to_i
    puts "Set new feed level, from 1 to 10: "
    @feed_level = gets.strip.to_i
    puts "Set new water level, from 1 to 10: "
    @water_level = gets.strip.to_i
    puts "Set new energy level, from 1 to 10: "
    @energy = gets.strip.to_i
    puts "Set new mood level, from 1 to 10: "
    @mood = gets.strip.to_i
    update_states
    save
  end
end
